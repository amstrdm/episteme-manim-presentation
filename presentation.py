...
class Presentation(Slide):
    ...
    def Scene4_Technology_Stack(self):
        # Slide Header
        bausteine_t = Text("Die Bausteine", font_size=48)
        ...
        react_logo_group.next_to(fastapi_logo_group, UP, buff=0.8).shift(RIGHT * 3)
        ...
        deployment_t = Text("Deployment", font_size=25, color=PresentationColors.ACCENT_MAIN)
        ...
        self.play(Create(deployment_group))
        ...
        # 4. Finally, show them
        self.play(Create(deployment_logo_group))
